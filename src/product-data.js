const productsData = [
    {
      ...
      category: "Phone",
      brand: "Itel",
      desc: "A33 Plus Multi-Functions Fingerprint Multi Functions Fingerprint Sensor Fingerprint sensor is not just for unlock. A33 plus come with multi functions fingerprint sensor which allow you to unlock apps, take photos, record videos, answer phone calls, record phone calls, stop alarm clock, even customize any of your fingerprints as unique shortcut to launch apps in a second.",
    },
    {
      id: 2,
      name: "Xioomi Redmi",
      ...
      category: "Phone",
      brand: "Xiaomi",
      desc: "Xioomi Redmi Multi-Functions Fingerprint Multi Functions Fingerprint Sensor Fingerprint sensor is not just for unlock. A33 plus come with multi functions fingerprint sensor which allow you to unlock apps, take photos, record videos, answer phone calls, record phone calls, stop alarm clock, even customize any of your fingerprints as unique shortcut to launch apps in a second.",
    },
    {
      id: 3,
